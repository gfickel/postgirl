...
// Shared request editing state (persists across frames)
...
// Arg type options per request type
static const char* get_types[] = {"Text"};
static const char* post_types[] = {"Text", "File"};
static const char* delete_types[] = {"Text"};
static const char* patch_types[] = {"Text", "File"};
static const char* put_types[] = {"Text", "File"};
static const char** arg_types[] = {get_types, post_types, delete_types, patch_types, put_types};
static int num_arg_types[] = {1, 2, 1, 2, 2};

// Cross-panel state
static bool picking_file = false;
static int curr_arg_file = 0;
static int curr_collection = 0;
static bool update_hist_search = true;
...
void renderHistoryPanel(pg::Vector<Collection>& collection,
                        const pg::Vector<pg::String>& request_type_str)
{
...
void renderRequestPanel(std::thread& thread,
                        std::atomic<ThreadStatus>& thread_status,
                        pg::Vector<Collection>& collection)
{
...
int main(int argc, char* argv[])
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        renderHistoryPanel(collection, request_type_str);
        ImGui::SameLine();
        renderRequestPanel(thread, thread_status, collection);
